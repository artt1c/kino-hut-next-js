...
const Header = () => {
  return (
    <header className="flex gap-4 items-center h-auto my-4">

      <div className="flex-1 max-w-72 ">
        <SuspenseWrapper>
          <LinkWithParams href="/" className="flex items-center gap-2 min-h-20 font-bold text-4xl py-4 px-8 bg-(--background-transparent) rounded-4xl">
      ...
      <div className='flex-4 flex justify-center'>
        <div className="flex-1 flex items-center gap-4 max-w-[1680px] p-4 bg-(--background-transparent) rounded-4xl">
          <SuspenseWrapper>
            <CategoryDropList/>
          </SuspenseWrapper>
          <SearchForm/>
