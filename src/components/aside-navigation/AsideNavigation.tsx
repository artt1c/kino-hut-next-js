...
const AsideNavigation = () => {
  return (
    <aside className="text-2xl font-semibold  brightness-75">

      <ul className="mb-12">
        <li>
          <LinkWithParams href={'/'} className="flex items-center gap-4 mb-3 w-fit">
        ...
        <li>
          <LinkWithParams href={'/favorite'} className="flex items-center gap-4 mb-3 w-fit">
        ...
        <li>
          <LinkWithParams href={'/upcoming'} className="flex items-center gap-4 mb-3 w-fit">
        ...
        <li>
          <LinkWithParams href={'/popular'} className="flex items-center gap-4 mb-3 w-fit">
      ...
      <ul className="mb-8">
        <li>
          <LinkWithParams href={'/settings'} className="flex items-center gap-4 mb-3 w-fit">
        ...
        <li>
          <LinkWithParams href={'/support'} className="flex items-center gap-4 mb-3 w-fit">
      ...
      <div>
        <p className="flex items-center gap-4 mb-3 w-fit">
